    ...
    def post(self, request):
        ...
        if transaksiSerializer.is_valid():
            ...
            for item in body['data']:
                ...
                # Check if product quantity not bigger than stock
                ...
                if item['quantity'] > stock:
                    ...
                    return JsonResponse({
                        'error': True,
                        'message': f"Quantity of product_id: {item['product_id']}, must be lower than stock"
                    })
                else:
                    payload_data.append({
            ...
            if serializer.is_valid():
                ...
                if productSerializers.is_valid():
                    ...
                    return JsonResponse({
                        'error': False,
                        'data': 'Save transaksi successfully'
                    })
                else:
                    return JsonResponse({
                        'error': True,
